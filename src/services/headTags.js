export const getDescription = (lang) => {
  switch (lang) {
    case "UA":
      return "Автобусні квитки для поїздок Україною, Європою та СНД. Великий вибір рейсів. Безкоштовне бронювання та легка покупка. Гарантія повернення коштів за квиток - Vezer.ua";
    case "RU":
