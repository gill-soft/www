...
class SearchForm extends Component {
  ...
  handleSubmit = (e) => {
    ...
    // const fromId = from.value || this.getId(from, "from");
    // const toId = to.value || this.getId(to, "to");
  ...
  render() {
    ...
    return (
      <form onSubmit={this.handleSubmit} className={`${styles.form} `}>
        ...
        {/* </div> */}
        {/* </div> */}
        <AutoComplete3 id="from" error={this.state.errorFrom} />
        {/* <AutoComplete3 id="to" error={this.state.errorTo}/> */}
