...
const OrderPage = ({ history }) => {
  ...
  const [requeredFields, setRequeredFields] = useState(["NAME", "PATRONYMIC", "SURNAME", "ONLY_LATIN", "EMAIL", "PHONE", "GENDER", "CITIZENSHIP", "DOCUMENT_TYPE", "DOCUMENT_NUMBER", "DOCUMENT_SERIES",  "SEAT", "TARIFF"]);
